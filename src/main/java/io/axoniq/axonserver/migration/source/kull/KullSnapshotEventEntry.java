...
@NamedQuery(name = "KullSnapshotEventEntry.findByTimestamp", query = "select e from KullSnapshotEventEntry e where e.timeStamp >= :lastTimeStamp order by e.timeStamp asc, e.eventIdentifier")
@IdClass(KullSnapshotEventEntry.PK.class)
public class KullSnapshotEventEntry extends BaseEventEntry implements SnapshotEvent {
    ...
    public static class PK implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            KullSnapshotEventEntry.PK pk = (KullSnapshotEventEntry.PK) o;
